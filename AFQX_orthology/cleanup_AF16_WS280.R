...
#read gff
ws280 <- read.gff("/projects/b1059/projects/Nicolas/c.briggsae/wormbase/WS279/c_briggsae.PRJNA10731.WS280.annotations.gff3")

#extract WormBase features only
anno_WB_only <- ws280 %>% dplyr::filter(source=="WormBase") %>%
...
#write out clean GFF
write.table(clean_GFF,file="/projects/b1059/projects/Nicolas/c.briggsae/wormbase/WS279/c_briggsae.PRJNA10731.WS280.protein_coding.gff",quote = F,sep = "\t",row.names = F,col.names = F,na = ".")
